...
- [Basic Auth](AUTH-SESSIONS.md)
- [Digest Auth](DIGEST-AUTH.md)
...
- [Strip Prefix](STRIP-PREFIX.md)
- [Add Prefix](ADD-PREFIX.md)
- [Replace Path](REPLACE-PATH.md)
- [Redirect HTTPS](REDIRECT-SCHEME.md)
- [Redirect Regex](REDIRECT-REGEX.md)
- [Middleware Chain](CHAIN.md)

## Operations

- [Dashboard CRUD](DASHBOARD-CRUD.md)
- [Auth & Sessions](AUTH-SESSIONS.md)
- [TLS Certificate Management](CERT-MANAGEMENT.md)
